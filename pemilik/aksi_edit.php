                    ...
                    <form class="form-input" method="POST">
                        <table class="table-input">
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="Model" value=<?php echo $r['Model']; ?> class="input-data">
                                </td>
                            </tr>
                            <tr>
                                <td class="nama-data">
                                ...
                                <td>
                                    <input type="text" name="NoRegistrasi" value=<?php echo $r['NoRegistrasi']; ?> class="input-data">
                                </td>
                                <td class="nama-data">
                                    <label for="">Tahun Pembuatan</label>
                                </td>
                                <td>
                                    <input type="year" name="TahunPembuatan" value=<?php echo $r['TahunPembuatan']; ?> class="input-data">
                                </td>
                            </tr>
                            <tr>
                                <td class="nama-data">
                                ...
                                <td>
                                    <input type="text" name="NamaPemilik" value=<?php echo $r['NamaPemilik']; ?> class="input-data">
                                </td>
                                <td class="nama-data">
                                    <label for="">Isi Silinder</label>
                                </td>
                                <td>
                                    <select name="IsiSilinder" class="input-data" value=<?php echo $r['IsiSilinder']; ?>>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="Alamat" value="<?php echo $r['Alamat']; ?>" class="input-data">
                                </td>
                                <td class="nama-data">
                                    <label for="">Bahan Bakar</label>
                                </td>
                                <td>
                                    <select name="BahanBakar" value=<?php echo $r['BahanBakar']; ?> class="input-data">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="NoRangka" value="<?php echo $r['NoRangka']; ?>" class="input-data">
                                </td>
                                <td class="nama-data">
                                    <label for="">Warna TNKB</label>
                                </td>
                                <td>
                                    <select name="WarnaTNKB" value=<?php echo $r['WarnaTNKB']; ?> class="input-data">
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="text" name="NoMesin" value=<?php echo $r['NoMesin']; ?> class="input-data">
                                </td>
                                <td class="nama-data">
                                    <label for="">Tahun Registrasi</label>
                                </td>
                                <td>
                                    <input type="text" name="TahunRegistrasi" value=<?php echo $r['TahunRegistrasi']; ?> class="input-data">
                                </td>
                            </tr>
                            <tr>
                                <td class="nama-data">
                                ...
                                <td>
                                    <input type="text" name="PlatNO" value=<?php echo $r['PlatNO']; ?> class="input-data">
                                </td>
                                <td class="nama-data">
                                    <label for="">No BPKB</label>
                                </td>
                                <td>
                                    <input type="text" name="NoBPKB" value=<?php echo $r['NoBPKB']; ?> class="input-data">
                                </td>
                            </tr>
                            <tr>
                                <td class="nama-data">
                                ...
                                <td>
                                    <input type="text" name="Merk" value=<?php echo $r['Merk']; ?> class="input-data">
                                </td>
                                <td class="nama-data">
                                    <label for="">Kode Lokasi</label>
                                </td>
                                <td>
                                    <input type="text" name="KodeLokasi" value=<?php echo $r['KodeLokasi']; ?> class="input-data">
                                </td>
                            </tr>
                            <tr>
                                <td class="nama-data">
                                ...
                                <td>
                                    <input type="text" name="Type_Motor" value=<?php echo $r['Type_Motor']; ?> class="input-data">
                                </td>
                                <td class="nama-data">
                                    <label for="">Masa Berlaku STNK</label>
                                </td>
                                <td>
                                    <input type="date" name="MasaBerlakuSTNK" value=<?php echo $r['MasaBerlakuSTNK']; ?> class="input-data">
                                </td>
                            </tr>
                        </table>
