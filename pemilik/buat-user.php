...
if (isset($_POST['tambah'])) {
	...
	$query = mysqli_query($koneksi, "INSERT INTO user VALUES ('$id_user','$nama','$pass','$hak_akses',CURDATE(),'')") or die($koneksi);
	if ($query) {
			...
			<div class="view-table">
				...
				<div class="table">
					<form class="form-input" method="POST">
						...
						<button type="submit" name="tambah" class="btn" onclick="return confirm('Apakah anda yakin ingin membuat data user?')">Simpan</button>
					</form>
				</div>
			</div>
		</section>
